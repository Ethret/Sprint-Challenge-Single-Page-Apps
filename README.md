...
> Answer: Less data is downloaded to display new content, don't need full-page refreshes to display new content, can show "loading" notifications and stuff like that. Limits or stops requests to the server.
